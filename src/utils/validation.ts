...
export const createGymSchema = z.object({
  ...
  description_th: z.string().max(1000, 'Thai description too long').optional(),
...
export const updateGymSchema = createGymSchema.partial().refine(
...
export const createTrainerSchema = z.object({
  ...
  bio_th: z.string().max(2000, 'Thai bio too long').optional(),
  bio_en: z.string().max(2000, 'English bio too long').optional(),
  phone: phoneSchema,
  email: emailSchema.optional(),
  line_id: lineIdSchema,
